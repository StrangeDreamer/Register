...
<table id="dg" title="挂号信息" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="GuaHao" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="patientId" width="50" align="center" >患者ID</th>
	...
	<div id="dlg" class="easyui-dialog" style="width: 340px;height: 340px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>		
					<td>患者姓名：</td>
					<td><input class="easyui-combobox" id="patientId" name="guahao.patientId" style="width: 155px" data-options="editable:true,valueField:'patientId',textField:'patientName',url:'patient!patientNameComboList'"/></td>
				</tr>
				<tr>
					<td>选择日期：</td>
